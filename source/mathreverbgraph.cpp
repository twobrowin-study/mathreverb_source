...
, mSampleRate (sampleRate)
{
  ...
  DelayPoint modelApexesDelay [4][4] = {
    ...
    {
      DelayPoint (sourceApex, 0.05f * mSampleRate),
      DelayPoint (modelApexes + 0, 0.10f * mSampleRate),
      DelayPoint (modelApexes + 2, 0.10f * mSampleRate),
      DelayPoint (modelApexes + 3, 0.10f * mSampleRate)
    },
    {
      DelayPoint (sourceApex, 0.05f * mSampleRate),
    ...
    },
    {
      DelayPoint (sourceApex, 0.05f * mSampleRate),
      DelayPoint (modelApexes + 0, 0.10f * mSampleRate),
      DelayPoint (modelApexes + 1, 0.10f * mSampleRate),
      DelayPoint (modelApexes + 2, 0.10f * mSampleRate)
    }
  };
